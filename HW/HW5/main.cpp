...
// ===================================================================
void MoreTests() {
  //pushback numbers 10 - 20
  std::cout<<"Starting More Tests"<<std::endl;
  UnrolledLL<int> a;
  UnrolledLL<int> b;
  for (int i = 10; i < 30; ++i) {
    a.push_back(i);
...
//prints out the node
  ...
  a.print(std::cout);
  std::cout << std::endl;
//pushfront and pop front, this shouldn't change the nodes at all. There shouldn't be any empty nodes as well
  UnrolledLL<int>::iterator a_iter = a.begin();
  std::cout<<"Pushback and Popback"<<std::endl;
  a.push_front(1000);
  a.push_front(1000);
  a.push_front(1000);
  a.push_front(1000);
  ...
  a.print(std::cout);
  std::cout<<std::endl;
  std::cout<<"erase everything"<<std::endl;
  //deletes everything in the node. The size should be zero and no nodes at all. 
  a_iter = a.begin();
  while (a_iter != a.end()) {
      a_iter = a.erase(a_iter); 
    } 
  ...
  a.print(std::cout);
  std::cout<<std::endl;
  //copy b to a, a should display 10-30
  std::cout<<"copy b to a -- print a"<<std::endl;
  a=b;
  a.print(std::cout);
  a.clear();
  b.clear();
